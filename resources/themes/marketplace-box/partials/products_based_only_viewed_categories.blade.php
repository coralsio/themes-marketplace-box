@php $products = \Shop::getProductsBasedOnViewedCategories(); @endphp

@if($products->isNotEmpty())
    <h3 class="widget-title">{{ trans('corals-marketplace-box::labels.partial.products_based_on_history') }}</h3>
